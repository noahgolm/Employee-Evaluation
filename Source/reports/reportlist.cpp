...
const int employer_box_height = 350;
const int employee_box_height = 350;
const int evaluation_box_height = 700;
...
void ReportList::moveToBox(int pos)
{
    reports->setCurrentIndex(pos);
}

void ReportList::print()
{
    Printer::printEmployeeList(employeeData, sort);
}
